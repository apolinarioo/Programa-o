...
export class BooksController {
    ...
    private booksWeLove: Book[];
    private booksClassic: Book[];
    private booksRomance: Book[];
    private booksKids: Book[];
    private booksTextbook: Book[];
    ...
    constructor() {
        this.initializeBooksWeLove();
        this.initializeBooksClassic();
        this.initializeBooksRomance();
        this.initializeBooksKids();
        this.initializeBooksTextbook();
    }

    initializeBooksWeLove(): void {
        this.booksWeLove = [this.b1, this.b2, this.b3, this.b4, this.b5, this.b6, this.b7, this.b8, this.b9];
    }

    initializeBooksClassic(): void {
       this.booksClassic = [this.b1, this.b2, this.b3, this.b4, this.b5, this.b6, this.b7, this.b8, this.b9];
    }

    initializeBooksRomance(): void {
        this.booksRomance = [this.b1, this.b2, this.b3, this.b4, this.b5, this.b6, this.b7, this.b8, this.b9];
    }

    initializeBooksKids(): void {
        this.booksKids = [this.b1, this.b2, this.b3, this.b4, this.b5, this.b6, this.b7, this.b8, this.b9];
    }

    initializeBooksTextbook(): void {
        this.booksTextbook = [this.b1, this.b2, this.b3, this.b4, this.b5, this.b6, this.b7, this.b8, this.b9];
    }

    getBooksTextbook(): Book[] {
        return this.booksTextbook;
    }

    getBooksKids(): Book[] {
        return this.booksKids;
    }

    getBooksRomance(): Book[] {
        return this.booksRomance;
    }

    getBooksClassic(): Book[] {
        return this.booksClassic;
    }

    getBooksWeLove(): Book[] {
        return this.booksWeLove;
    }
